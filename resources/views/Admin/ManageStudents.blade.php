						...
						<div class="d-flex my-xl-auto right-content">
							<div class="mb-xl-0">
								<div class="btn-group dropdown">
									<a href="/AD_AddStudent"><button type="button" class="btn btn-primary">Add Student</button></a>
								</div>
							</div>
						</div>
					</div>
												...
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-icon-list">
                                                            <a href="/AD_ViewStudents/<?= $Student->S_ID  ?>"><button class="btn btn-warning btn-icon mr-1"><i class="fa fa-eye"></i></button></a>
                                                            <?php 
                                                                if($Student->S_STATUS == 1){
                                                            ...
                                                            ?>
                                                            <a href="/AD_EditStudent/<?= $Student->S_ID  ?>"><button class="btn btn-primary btn-icon ml-1 mr-1"><i class="far fa-edit"></i></button></a>
                                                            <a href="/AD_DeleteStudent/<?= $Student->S_ID  ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn btn-danger btn-icon mr-1"><i class="far fa-trash-alt"></i></button></a>
                                                        </div>
                                                    </td>
