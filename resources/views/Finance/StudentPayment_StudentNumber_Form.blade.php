					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
                                ...
                                <h4 class="content-title mb-0 my-auto">Get Student Payment</h4>
							</div>
						</div>
						<div class="d-flex my-xl-auto right-content">
							<div class="mb-xl-0">
								<div class="btn-group dropdown">
									<a href="/StudentPayment_ManageStudentPayments"><button type="button" class="btn btn-primary">Manage Student Payments</button></a> 
								</div>
							</div>
						</div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Get Student Payment</h4>
								</div>
                                

                                
								<div class="card-body pt-0">
									<form action="GetPaymentPortal" method="GET" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                        ...
                                        <input type="submit" class="btn btn-primary mt-3 mb-0" value="GET" name="save">
									</form>
								</div>
							</div>
						</div>
