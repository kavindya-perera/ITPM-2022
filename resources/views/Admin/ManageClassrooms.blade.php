					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								...
								<h4 class="content-title mb-0 my-auto">Manage Classrooms</h4>
							</div>
						</div>
						<div class="d-flex my-xl-auto right-content">
							<div class="mb-xl-0">
								<div class="btn-group dropdown">
									<a href="/AD_AddClassRoom"><button type="button" class="btn btn-primary">Create Classroom</button></a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Manage Classrooms</h4>
										...
										<table id="example1" class="table key-buttons text-md-nowrap">
                                            ...
                                            ?>  
												<tr>
                                                    ...
                                                    <td><?= $classroom->C_DESCRIPTION ?></td>
                                                    <td>
                                                        <div class="btn-icon-list">
                                                            <a href="/AD_EditClassRoom/<?= $classroom->C_ID  ?>"><button class="btn btn-primary btn-icon ml-1 mr-1"><i class="far fa-edit"></i></button></a>
                                                            <a href="/AD_DeleteClassRoom/<?= $classroom->C_ID  ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn btn-danger btn-icon mr-1"><i class="far fa-trash-alt"></i></button></a>
                                                        </div>
                                                    </td>
