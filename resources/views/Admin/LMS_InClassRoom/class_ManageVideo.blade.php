                    ...
                    <div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								...
								<h4 class="content-title mb-0 my-auto">Manage Video Lesson</h4>
							</div>
						</div>
					</div>
					<!-- breadcrumb -->
							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Manage Videos</h4>
												...
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-icon-list">
                                                            <a href="/class_PlayVideoLesson/<?= $video->V_ID."/".$classroom[0]->C_ID?>"><button class="btn btn-dark btn-with-icon btn-block"><i class="fa fa-play"></i> Play</button></a>
                                                            <a href="/class_EditVideoLesson/<?= $video->V_ID."/".$classroom[0]->C_ID?>"><button class="btn btn-primary btn-icon ml-1 mr-1"><i class="far fa-edit"></i></button></a>
                                                            <a href="/class_DeleteVideoLesson/<?= $video->V_ID."/".$classroom[0]->C_ID?>" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn btn-danger btn-icon mr-1"><i class="far fa-trash-alt"></i></button></a>
                                                        </div>
                                                    </td>
