					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
                                ...
                                <h4 class="content-title mb-0 my-auto"> Edit Expenses</h4>
							</div>
						</div>
						<div class="d-flex my-xl-auto right-content">
							<div class="mb-xl-0">
								<div class="btn-group dropdown">
									<a href="/Manage_Expenses"><button type="button" class="btn btn-primary">Manage Expenses</button></a> 
								</div>
							</div>
						</div>
                    ...
                    <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Edit Expenses</h4>
								</div>
                                
                                <?php
                                    $date=date_create($expenses[0]->E_DATE);
								...
								<div class="card-body pt-0">
									<form action="/ExpensesUpdateAction/<?=$expenses[0]->E_ID ?>" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
					
                                        <label>Pay Date <font color="red">*</font></label>
                                        <div class="row"> 
                                        <div class="col-lg-2 col-xl-4 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="E_YEAR" value="<?=$p_Year ?>"  maxlength="4" required>
                                            </div>
                                        </div>
                                        
                                        <div class="col-lg-3 col-xl-5 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <select name="E_MONTH" class="form-control" required>
                                        ...
                                        <div class="col-lg-3 col-xl-3 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <select name="E_DATE" class="form-control" required>
                                        ...
                                        <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="E_AMOUNT"  value="<?=$expenses[0]->E_AMOUNT ?>" maxlength="50" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label>Pay For <font color="red">*</font></label>
                                                <input type="text" class="form-control" name="E_FOR" value="<?=$expenses[0]->E_FOR?>" maxlength="150" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="E_DESCRIPTION" class="form-control" rows="4" maxlength="150"><?=$expenses[0]->E_DESCRIPTION?></textarea>
                                            </div>
                                        </div>
