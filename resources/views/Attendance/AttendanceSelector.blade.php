					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
                                ...
                                <h4 class="content-title mb-0 my-auto">Student Selector</h4>
							</div>
						</div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Student Selector</h4>
								</div>
                                

                                
								<div class="card-body pt-0">
									<form action="/GetStudentAttendance" method="GET" enctype="multipart/form-data">
                                    {{csrf_field()}}
