					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								...
								<h4 class="content-title mb-0 my-auto">Manage Students Payments</h4>
							</div>
						</div>
						<div class="d-flex my-xl-auto right-content">
							<div class="mb-xl-0">
								<div class="btn-group dropdown">
									<a href="/Get_Student_Payment"><button type="button" class="btn btn-primary">Get Student Payment</button></a>
								</div>
							</div>
						</div>
					</div>
								...
								<div class="card-header pb-0">
									...
									<div class="d-flex justify-content-between">
                                        <div class="btn-icon-list">
                                            <a class="ml-1 mr-1"><button class="btn btn-dark btn-block " data-effect="effect-scale" data-toggle="modal" href="#modaldemo8">Filter by Student</button></a>
                                            ...
                                            <a href="/Manage_Student_Payments_Today" class="ml-1 mr-1"><button class="btn btn-dark btn-block " >Today</button></a>
                                        </div>
										...
										<table id="example1" class="table key-buttons text-md-nowrap">
                                            ...
                                            ?>  
												<tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-icon-list">
                                                            <a href="/AD_EditPayment/<?= $Payment->SP_ID ?>" onclick="return confirm('Are you sure you want to edit this payment?');"><button class="btn btn-primary btn-icon ml-1 mr-1"><i class="far fa-edit"></i></button></a>
                                                            <a href="/AD_DeletePayment/<?= $Payment->SP_ID ?>" onclick="return confirm('Are you sure you want to delete this payment?');"><button class="btn btn-danger btn-icon mr-1"><i class="far fa-trash-alt"></i></button></a>
                                                        </div>
                                                    </td>
												</tr>
                                            <?php endforeach ?>
				...
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
							<h6 class="modal-title">Filter by Student</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
						</div>
						<div class="modal-body">
                                    <form action="/Manage_Student_Payments/StudentBy" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
										<div class="row"> 
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label>Student Number <font color="red">*</font></label>
                                                    <input type="text" class="form-control" name="STUDENT_NUMBER"  maxlength="10" autofocus required>
                                                </div>
                                            </div>
										</div>
			...
			<div class="modal" id="modaldemo9">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content modal-content-demo">
						...
						<div class="modal-body">
                                    <form action="/Manage_Student_Payments/DateBy" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
										<div class="row"> 
