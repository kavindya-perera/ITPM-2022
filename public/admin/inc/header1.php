			...
			<aside class="app-sidebar sidebar-scroll ">
				<div class="main-sidebar-header active">
					<a class="desktop-logo logo-light active" href="/AD_Dashboard"><img src="/admin/assets//img/brand/logo.png" class="main-logo" alt="logo"></a>
					<a class="desktop-logo logo-dark active" href="/AD_Dashboard"><img src="/admin/assets//img/brand/logo-white.png" class="main-logo dark-theme" alt="logo"></a>
					<a class="logo-icon mobile-logo icon-light active" href="/AD_Dashboard"><img src="/admin/assets//img/brand/favicon.png" class="logo-icon" alt="logo"></a>
					<a class="logo-icon mobile-logo icon-dark active" href="/AD_Dashboard"><img src="/admin/assets//img/brand/favicon-white.png" class="logo-icon dark-theme" alt="logo"></a>
				</div>
					...
					<div class="container-fluid">
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="/AD_Dashboard"><img src="/admin/assets//img/brand/logo.png" class="logo-1" alt="logo"></a>
								<a href="/AD_Dashboard"><img src="/admin/assets//img/brand/logo-white.png" class="dark-logo-1" alt="logo"></a>
								<a href="/AD_Dashboard"><img src="/admin/assets//img/brand/favicon.png" class="logo-2" alt="logo"></a>
								<a href="/AD_Dashboard"><img src="/admin/assets//img/brand/favicon-white.png" class="dark-logo-2" alt="logo"></a>
							</div>
