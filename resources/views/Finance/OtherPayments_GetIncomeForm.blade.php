					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
                                ...
                                <h4 class="content-title mb-0 my-auto"> Get Other Income</h4>
							</div>
						</div>
                    ...
                    <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Other Income</h4>
								</div>
                                

                                
								<div class="card-body pt-0">
									<form action="OtherIncomeInsertAction" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                        <input type="text" class="form-control" name="O_INVOICE" value="<?=$InvoiceNumber?>" hidden required>
										...
										<div class="row"> 
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="O_CUSTOMER_NAME"  maxlength="150" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="O_CUSTOMER_CONTACT"  maxlength="10" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="O_CUSTOMER_ADDRESS" class="form-control" maxlength="255" rows="3" required></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-lg-2 col-xl-4 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="O_YEAR" value="<?=date('Y')?>"  maxlength="4" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="O_AMOUNT"   maxlength="50" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label>Payment For <font color="red">*</font></label>
                                                <input type="text" class="form-control" name="O_FOR"  maxlength="150" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label>Remark</label>
                                                <textarea name="O_REMARK" class="form-control" rows="2" maxlength="150"></textarea>
                                            </div>
                                        </div>
                                        
                                    </div>

                                        <input type="submit" class="btn btn-primary mt-3 mb-0" value="SUBMIT" name="save">
									</form>
								</div>
							</div>
						</div>
