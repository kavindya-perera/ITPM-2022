					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								...
								<h4 class="content-title mb-0 my-auto">Edit Task</h4>
							</div>
						</div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								...
								<div class="card-body pt-0">
									<form action="/TaskEdit/<?php echo $Task[0]->T_ID; ?>" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
										...
										<div class="row"> 
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="TASK_NAME" value="<?php echo $Task[0]->T_NAME; ?>"  maxlength="100" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="TASK_DESCRIPTION" class="form-control" maxlength="500" rows="3" required><?php echo $Task[0]->T_DESCRIPTION; ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="TASK_FROM" value="<?php echo $Task[0]->T_TIME_FROM; ?>" maxlength="100" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="TASK_TO" value="<?php echo $Task[0]->T_TIME_TO; ?>"  maxlength="100" required>
                                                </div>
                                            </div>
