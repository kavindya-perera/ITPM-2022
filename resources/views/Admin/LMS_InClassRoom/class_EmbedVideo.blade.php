					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								...
								<h4 class="content-title mb-0 my-auto">Embed Video Lesson</h4>
							</div>
						</div>
					</div>
					<!-- breadcrumb -->
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Embed Video</h4>
								</div>
								...
								<div class="card-body pt-0">
									...
									<form action="/EmbedVideoAction/<?=$classroom[0]->C_ID?>" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
										...
										<div class="row"> 
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="V_SUBJECT"  maxlength="100" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="V_CHAPTER"  maxlength="100" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="V_NAME"  maxlength="200" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="V_DESCRIPTION"  class="form-control"  rows="3" maxlength="200"></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="V_CODE"  class="form-control"  rows="3" maxlength="10000"></textarea>
                                                </div>
                                            </div>
										
										</div>
                                        <input type="submit" class="btn btn-primary mt-3 mb-0" value="EMBED" name="save">
									</form>
								</div>
							</div>
						</div>
