							...
							<div class="card mg-b-20">
								<div class="card-header pb-0">
									<div class="d-flex justify-content-between">
										<h4 class="card-title mg-b-0">Student Attendance</h4>
                                    ...
                                    <table id="example1" class="table key-buttons text-md-nowrap">
                                            ...
                                            ?>  
												...
												<tr>
													...
													<td><?= $Attendance->S_NUMBER ?></td>
													<td><?= $Attendance->S_FULL_NAME ?></td>
													<td><a href="DeleteAttendance/<?= $Attendance->A_ID  ?>" onclick="return confirm('Are you sure you want to delete this item?');"><button class="btn btn-danger btn-icon mr-1"><i class="far fa-trash-alt"></i></button></a></td>
