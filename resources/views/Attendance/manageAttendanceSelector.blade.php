					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
                                ...
                                <h4 class="content-title mb-0 my-auto">Manage Attendance</h4>
							</div>
						</div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Select Date Range</h4>
								</div>
								...
								<div class="card-body pt-0">
									...
									<form action="/ManageAttendance" method="GET" enctype="multipart/form-data">
                                    {{csrf_field()}}
										...
										<div class="row"> 
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="Date_From"  maxlength="100" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="Date_To"  maxlength="100" required>
                                                </div>
                                            </div>
