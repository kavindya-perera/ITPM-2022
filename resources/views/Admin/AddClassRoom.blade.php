					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
                                ...
                                <h4 class="content-title mb-0 my-auto"> Create Classroom</h4>
							</div>
						</div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Create New Class</h4>
								</div>
                                

                                
								<div class="card-body pt-0">
									<form action="CreateClassRoom" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
										...
										<div class="row"> 
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="CLASSROOM_NAME"  maxlength="100" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="CLASSROOM_DESCRIPTION" class="form-control" maxlength="500" rows="3" required></textarea>
                                                </div>
                                            </div>
										</div>
