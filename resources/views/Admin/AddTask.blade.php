					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								...
								<h4 class="content-title mb-0 my-auto">Create Task</h4>
							</div>
						</div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Create New Task</h4>
								</div>
								...
								<div class="card-body pt-0">
                                    ...
                                    {{csrf_field()}}
                                        ...
                                        <div class="row">
                                            <div class="col-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" value="<?= $TaskNumber ?>" name="TASK_NUMBER"  maxlength="100" readonly required>
                                                </div>
                                            </div>
                                        </div>
										...
										<div class="row"> 
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label>Task Name <font color="red">*</font></label>
                                                    <input type="text" class="form-control" name="TASK_NAME"  maxlength="100" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label>Assign Emloyee <font color="red">*</font></label>
                                                    <select name="TASK_EMPLOYEE" class="form-control select2" required>
                                                        <option value="" selected disabled hidden>Choose here</option>
                                                        <?php foreach($Employees AS $Employee): ?>
                                                            <option value="<?= $Employee->EM_ID ?>"><?= $Employee->EM_NUMBER ." | ". $Employee->EM_FirstName." ".$Employee->EM_LastName ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="TASK_DESCRIPTION" class="form-control" maxlength="500" rows="3" required></textarea>
                                                </div>
                                            </div>

                                            <div class="col-12"><hr><label>Time Duration</label></div>

                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label>From <font color="red">*</font></label>
                                                    <input type="date" class="form-control" name="TASK_FROM"  maxlength="100" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="TASK_TO"  maxlength="100" required>
                                                </div>
                                            </div>
