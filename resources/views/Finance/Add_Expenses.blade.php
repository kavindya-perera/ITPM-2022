					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
                                ...
                                <h4 class="content-title mb-0 my-auto"> Add Expenses</h4>
							</div>
						</div>
                    ...
                    <div class="col-lg-8 col-xl-8 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Add Expenses</h4>
								</div>
                                

                                
								<div class="card-body pt-0">
									<form action="ExpensesInsertAction" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                        ...
                                        <div class="col-lg-2 col-xl-4 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="E_YEAR" value="<?=date('Y')?>"  maxlength="4" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="E_AMOUNT"   maxlength="50" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <label>Pay For <font color="red">*</font></label>
                                                <input type="text" class="form-control" name="E_FOR"  maxlength="150" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="E_DESCRIPTION" class="form-control" rows="4" maxlength="150"></textarea>
                                            </div>
                                        </div>
