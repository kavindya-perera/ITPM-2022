					...
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								...
								<h4 class="content-title mb-0 my-auto">Edit Classroom</h4>
							</div>
						</div>
						<div class="d-flex my-xl-auto right-content">
							<div class="mb-xl-0">
								<div class="btn-group dropdown">
									<a href="/AD_ManageClassRoom"><button type="button" class="btn btn-primary">Manage Classrooms</button></a> 
								</div>
							</div>
						</div>
					</div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								<div class="card-header">
									<h4 class="card-title mb-1">Edit New Class</h4>
								</div>
                                

                                
								<div class="card-body pt-0">
									<form action="/ClassroomEdit/<?= $Classroom[0]->C_ID; ?>" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
										...
										<div class="row"> 
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    <label>Classroom Name <font color="red">*</font></label>
                                                    <input type="text" class="form-control" value="<?= $Classroom[0]->C_NAME; ?>" name="CLASSROOM_NAME"  maxlength="100" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="CLASSROOM_DESCRIPTION" class="form-control" maxlength="500" rows="3" required><?= $Classroom[0]->C_DESCRIPTION; ?></textarea>
                                                </div>
                                            </div>
